...
final class FishCollectionViewCellViewModelTests: XCTestCase {
    ...
    func testIconURL() throws {
        let legacyIconURI = try XCTUnwrap(fishes.first?.legacyIconURI, "Tests failed: testIconURL() from FishCollectionViewCellViewModelTests")
        ...
        XCTAssertEqual(fishCollectionViewCellViewModel.iconURL, URL(string: "https://raw.githubusercontent.com/alexislours/ACNHAPI/6df0d7318a97/icons/fish/bitterling.png"))
    }
