...
final class SeaCreaturesMapping: XCTestCase {
    ...
    func testSeaCreaturesJsonMapping() throws {
        let id = seaCreatures.first?.id
        ...
        let imageURI = seaCreatures.first?.legacyImageURI
        let iconURI = seaCreatures.first?.legacyIconURI
        XCTAssertEqual(id, 1)
